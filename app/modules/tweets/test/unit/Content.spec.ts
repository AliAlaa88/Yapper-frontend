...
describe('Content Component', () => {
    ...
    describe('Three Images', () => {
        it('renders three images with aspect-square class', () => {
            const content: ContentType = {
                text: 'Tweet with three images',
        ...
        it('uses grid layout with 1 column for three images', () => {
            const content: ContentType = {
                text: 'Three images',
                images: ['/image1.jpg', '/image2.jpg', '/image3.jpg'],
                videos: [],
    ...
    describe('Four Images', () => {
        it('renders four images with aspect-square class', () => {
            const content: ContentType = {
                text: 'Tweet with four images',
        ...
        it('uses grid layout with 2 columns for four images', () => {
            const content: ContentType = {
                text: 'Four images',
                images: ['/image1.jpg', '/image2.jpg', '/image3.jpg', '/image4.jpg'],
                videos: [],
