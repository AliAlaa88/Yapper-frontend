<template>
    <div class="flex items-center justify-between max-w-[425px] mt-3">
        ...
        <button
            ...
            @click.stop
        >
            <div class="p-2 rounded-full group-hover:bg-[var(--color-x-blue)]/10 transition-colors">
        ...
        <button
            ...
            @click.stop
        >
            <div class="p-2 rounded-full group-hover:bg-[var(--color-x-red)]/10 transition-colors">
                <svg viewBox="0 0 24 24" class="w-[18px] h-[18px] fill-current">
                    <path
