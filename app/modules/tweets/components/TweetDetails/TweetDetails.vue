<template>
    <div class="bg-primary">
                ...
                >
                    <div class="flex gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <Publisher :publisher="reply.user" :created-at="reply.createdAt" />
        ...
        <div v-if="isLoading" class="p-8 text-center">
            <div
                class="animate-spin rounded-full h-12 w-12 border-b-2 border-x-blue mx-auto mb-4"
            ></div>
...
const { tweetDetails, isLoading, error, replies, fetchTweetDetails, resetState } = useTweetDetails(
    tweetId.value,
)
