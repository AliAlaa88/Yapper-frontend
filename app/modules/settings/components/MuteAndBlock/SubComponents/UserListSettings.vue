<template>
    <DetailedPanel :title="title">
        <div class="w-full text-primary">
            ...
            <div v-if="query.isLoading.value" class="flex justify-center py-6">
                <div
            ...
            <div v-if="query.hasNextPage.value" ref="loadMore" class="flex justify-center py-4">
                <div
...
const users = computed(() => props.query.data.value?.pages.flatMap((page) => page.data.data) ?? [])
