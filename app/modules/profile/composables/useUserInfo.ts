...
export function useUserInfo(userId: Ref<string | undefined>, enabled: Ref<boolean> = ref(true)) {

    const { userQuery } = useUserActionsQuery(userId, undefined, undefined, enabled)
