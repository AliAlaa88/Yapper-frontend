...
export function useUserInfo(userId: Ref<string | undefined>, userName: Ref<string | undefined> = ref(undefined), meId: Ref<string | undefined> = ref(undefined)) {

    const { userQuery } = useUserActionsQuery(userId, userName, meId)
