    ...
    <div class="mt-auto my-4 relative">
        ...
        <template v-if="isCollapsed">
            ...
            >
                <template #trigger>
                    <div
                        class="flex items-center justify-center rounded-full hover:bg-hover cursor-pointer transition-colors"
                        @click="togglePopup"
                    >
                ...
                <template #content>
                    <div class="flex flex-col min-w-0">
                        <span class="font-bold text-primary text-sm whitespace-nowrap">
                            {{ user?.name || 'User' }}
                        </span>
                        <span class="text-secondary text-xs whitespace-nowrap">
            ...
            >
                <div
                    v-if="isPopupOpen"
                    :class="[
                        'absolute bottom-full mb-2 w-[280px] bg-primary rounded-2xl shadow-xl border border-primary overflow-hidden z-50',
                ...
                >
                    ...
                    <div
                        :class="[
                            'absolute bottom-0 transform translate-y-full w-0 h-0',
