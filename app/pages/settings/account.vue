...
const panelItems = {
    ...
    description: $t('settings.yourAccount_desc'),
    categories: [
        {
            label: $t('settings.accountInformation'),
            description: $t('settings.accountInformation_desc'),
            icon: UserRound,
            href: '/settings/your_yapper_data/account',
        },
        {
            label: $t('settings.changePassword'),
            description: $t('settings.changePassword_desc'),
            icon: KeyRound,
            href: '/settings/password',
        },
        {
            label: $t('settings.deleteYourAccount'),
            description: $t('settings.deleteYourAccount_desc'),
            icon: ShieldMinus,
