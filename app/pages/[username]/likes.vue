...
useSeo({
    title: `Posts liked by @${username} / Yapper`,
...
watch(
    ...
    (newProfile) => {
        if (newProfile) {
            useSeo({
                title: t('seo.likes.title', { name: newProfile.name, username: newProfile.username }),
                description: t('seo.likes.description', { name: newProfile.name }),
                keywords: t('seo.likes.keywords', { username: newProfile.username }),
            })
        }
    },
    { immediate: true }
